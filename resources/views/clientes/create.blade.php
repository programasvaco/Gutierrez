    ...
    <div class="col-md-10">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-plus-circle"></i> Crear Nuevo Cliente</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('clientes.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('domicilio') is-invalid @enderror" id="domicilio" name="domicilio" value="{{ old('domicilio') }}" placeholder="Calle, número, colonia">
                            @error('domicilio')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('cpostal') is-invalid @enderror" id="cpostal" name="cpostal" value="{{ old('cpostal') }}" maxlength="10">
                            @error('cpostal')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('rfc') is-invalid @enderror" id="rfc" name="rfc" value="{{ old('rfc') }}" maxlength="13" style="text-transform: uppercase;">
                            @error('rfc')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" class="form-control @error('correoe') is-invalid @enderror" id="correoe" name="correoe" value="{{ old('correoe') }}">
                            @error('correoe')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" class="form-control @error('dias_plazo') is-invalid @enderror"
                                id="dias_plazo" name="dias_plazo" value="{{ old('dias_plazo', 0) }}" min="0" max="365" required>
                            @error('dias_plazo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
