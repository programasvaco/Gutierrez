        ...
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-end">
                    ...
                    <a href="{{ route('inventarios.import') }}" class="btn btn-success">
                        <i class="fas fa-file-import"></i> Ajustar Inventario
                    </a>
                </div>
            </div>
        </div>
        <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="tipo_existencia" class="form-select">
                            <option value="">Todos</option>
                            <option value="con_stock" {{ request('tipo_existencia') == 'con_stock' ? 'selected' : '' }}>Con
                                Stock</option>
                            <option value="sin_stock" {{ request('tipo_existencia') == 'sin_stock' ? 'selected' : '' }}>Sin
                                Stock</option>
                            <option value="stock_bajo" {{ request('tipo_existencia') == 'stock_bajo' ? 'selected' : '' }}>
                                Stock Bajo</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="order_by" class="form-select">
                            <option value="producto" {{ request('order_by') == 'producto' ? 'selected' : '' }}>Producto
                            </option>
                            <option value="almacen" {{ request('order_by') == 'almacen' ? 'selected' : '' }}>Almacén
                            </option>
                            <option value="existencia" {{ request('order_by') == 'existencia' ? 'selected' : '' }}>
                                Existencia</option>
                        </select>
            ...
            @if ($inventarios->count() > 0)
                                    ...
                                    <td class="text-center">
                                        ...
                                        @elseif($inventario->existencia < $inventario->producto->stock_min)
                                            <span class="badge bg-warning text-dark"><i
                                                    class="fas fa-exclamation-triangle"></i> Bajo</span>
                ...
                <div class="d-flex justify-content-between align-items-center mt-4">
                    <div>
                        Mostrando {{ $inventarios->firstItem() }} - {{ $inventarios->lastItem() }} de
            ...
            @else
                <div class="alert alert-info text-center">
                    <i class="fas fa-info-circle"></i> No se encontraron registros de inventario con los filtros
                    seleccionados.
                </div>
            @endif
        </div>
